...
$_GET['module'] = 'energia'; // Define o módulo atual

require_once './src/includes/header.php';
require_once './src/models/Energia.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['editar']) && isset($_POST['id'])) {
        ...
        if ($energiaModel->update($_POST['id'], $data)) {
    ...
    if (isset($_POST['excluir']) && isset($_POST['id'])) {
        if ($energiaModel->delete($_POST['id'])) {
...
$registros = $energiaModel->buscarComFiltros($filtros);
$totalPendente = $energiaModel->getTotalPendente();
$mediaConsumo = $energiaModel->getMediaConsumo();
$consumoMensal = $energiaModel->getConsumoMensal();
