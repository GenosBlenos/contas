...
?>
    <div class="container">
        ...
        <div class="grid-menu flex flex-wrap justify-center gap-10 mb-6">
            ...
            <a class="menu-item bg-white border-2 border-gray-300 rounded-2xl shadow p-8 min-w-[250px] min-h-[250px] max-w-[340px] flex flex-col items-center justify-center text-center transition hover:border-[#4a90e2] hover:shadow-lg" href="index.php?page=internet">
                <img src="./assets/wifi.png" alt="Internet" class="w-[140px] h-[100px] object-contain mb-4">
                <div class="menu-label text-lg font-medium text-[#22223b]">Internet Predial</div>
            </a>
        </div>
        ...
        <div class="ajuda-container pt-20 pb-5 flex justify-center">
