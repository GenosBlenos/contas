...
$_GET['module'] = 'telefone'; // Define o módulo atual

require_once './src/includes/header.php';
require_once './src/models/Telefone.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['editar']) && isset($_POST['id'])) {
        ...
        if ($telefoneModel->update($_POST['id'], $data)) {
    ...
    if (isset($_POST['excluir']) && isset($_POST['id'])) {
        if ($telefoneModel->delete($_POST['id'])) {
...
$registros = $telefoneModel->buscarComFiltros($filtros);
...
?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg border-l-4 border-green-500 border-b-2 border-gray-300">
            ...
            <p class="text-2xl font-bold text-green-600"><?php echo number_format($mediaConsumo ?? 0, 2, ',', '.'); ?> Minutos</p>
        </div>
        ...
        <form action="" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    <label for="tridigito" class="block text-sm font-medium text-gray-700">Tridígito</label>
                    <input type="number" name="tridigito" id="tridigito"
                           class="mt-1 block w-full rounded-md border-gray-400 border-2 shadow-sm focus:border-[#072a3a] focus:ring focus:ring-[#072a3a] focus:ring-opacity-50">
                </div>
                <div>
                ...
                <div>
                    <label for="cobrar" class="block text-sm font-medium text-gray-700">Cobrar</label>
                    <input type="number" name="cobrar" id="cobrar" step="0.01"
                           class="mt-1 block w-full rounded-md border-gray-400 border-2 shadow-sm focus:border-[#072a3a] focus:ring focus:ring-[#072a3a] focus:ring-opacity-50">
                </div>
                <div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            ...
            <form action="" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                ...
                <div class="flex items-end">
                    ...
                    <a href="telefone.php" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-md shadow-sm ml-2">
                        Limpar
                    </a>
                </div>
            </form>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php foreach ($registros as $registro): ?>
                            <tr id="row-<?= htmlspecialchars($registro['id_telefone']) ?>">
...
<script>
    ...
    if (document.getElementById('consumoChart') && consumoData.length > 0) {
