...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg border-l-4 border-green-500" style="border-bottom: 2px solid gray;">
            <h3 class="text-lg font-semibold text-gray-800" style="border-bottom: 1px solid gray;">Veiculo mais utilizado</h3>
            <p class="text-2xl font-bold text-green-600"><?php echo htmlspecialchars($placa ?? ''); ?> - <?php echo htmlspecialchars($tipo ?? ''); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="checkbox" name="isento" id="isento" value="1"
                    class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-[#072a3a] focus:ring focus:ring-[#072a3a] focus:ring-opacity-50">
            </div>
            <div>
            ...
            <div>
                ...
                <select name="Conta_status" id="Conta_status" required style="border: 2px solid gray;" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#072a3a] focus:ring focus:ring-[#072a3a] focus:ring-opacity-50">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php foreach ($registros as $registro): ?>
                        <tr id="row-<?= htmlspecialchars($registro['placa']) ?>">
